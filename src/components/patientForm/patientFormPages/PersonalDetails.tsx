...
export const PersonalDetails = ({onChange}: PersonalDetailsProps) => {
    return (
        <>
            <div className="inputsContainer">
                <div className="namesContainer">
                    ...
                    <div className="dateOfbirth">
                        <TextInput label='Date of birth' name='day' placeholder="DD" style={{ width: '28px', marginLeft: '0px' }}  onChange={onChange}/>
                        <TextInput name='month' placeholder="MM" style={{ width: '28px', marginLeft: '0px' }}  onChange={onChange}/>
                        <TextInput name='year' placeholder="YYYY" style={{ width: '56px', marginLeft: '0px' }}  onChange={onChange}/>
                    </div>
